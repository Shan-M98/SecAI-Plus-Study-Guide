...
```bash
git clone https://github.com/Shan-M98/SecAI-Plus-Study-Guide.git
cd SecAI-Plus-Study-Guide
...
|----------|-------------|
| [Domain 1 Cheat Sheet](cheatsheets/domain1.html) | AI hierarchy, learning types, prompting, data concepts, RAG pipeline |
| [Domain 2 Cheat Sheet](cheatsheets/domain2.html) | Attacks by phase, defense-in-depth stack, data protection, monitoring |
| [Domain 3 Cheat Sheet](cheatsheets/domain3.html) | AI for defense vs offense, detection methods, MCP, AI dev tools |
...
Interactive tools to test your knowledge across multiple formats.
...
| [Fill in the Blank](practice/fill_blank.html) | 55 questions with blanked keywords, type-the-answer format |

## Module 3: Visual Aids

Visual references designed for quick review and spatial memorization.

| Visual | Description |
|--------|-------------|
| [AI/ML Concept Map](visuals/concept_map.html) | Hierarchical diagram showing how AI, ML, DL, NLP, LLMs, GANs nest and relate |
| [AI Lifecycle Timeline](visuals/lifecycle_timeline.html) | 7-phase timeline with threats (below) and controls (above) mapped to each stage |
| [OWASP LLM Top 10 Poster](visuals/owasp_poster.html) | Visual one-pager: all 10 risks with examples and mitigations |

## Module 4: Exam Prep

Strategy and tracking tools for the final push before exam day.

| Tool | Description |
|------|-------------|
| [Exam Day Strategy Guide](exam_prep/strategy_guide.html) | Time management, elimination techniques, common traps, checklists |
| [Score Tracker](exam_prep/score_tracker.html) | Log scores across all tools, identify weak domains, get study recommendations |
